  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-8">
      <section>
        ...
        <p className="text-lg mb-4 text-center text-muted-foreground font-light leading-relaxed"> Always open to new exciting, challenging opportunities and other types of collaboration. </p>
